...
class TopicSniffer(Node):
  ...
  def display_rates(self):
    ...
    # Clear terminal for cleaner live output
    os.system('clear')
    ...
    # Header
    print("📊 Live Topic Message Rates (last 2s window)")
    print("=" * (topic_col_width + 40))
    ...
    for topic_name, timestamps in sorted(self.topic_stats.items()):
      ...
      print(f"{display_name:<{topic_col_width}} {rate_str} {n:>8} {dur_str}")
